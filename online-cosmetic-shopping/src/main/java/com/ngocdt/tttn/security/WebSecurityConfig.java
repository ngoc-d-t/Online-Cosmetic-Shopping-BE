package com.ngocdt.tttn.security;

import com.ngocdt.tttn.security.jwt.JwtAuthEntryPoint;
import com.ngocdt.tttn.security.jwt.JwtAuthTokenFilter;
import com.ngocdt.tttn.security.jwt.JwtUtils;
import com.ngocdt.tttn.security.service.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
                ...
                .antMatchers("/api/shipper/**").access("hasRole('ROLE_SHIPPER') or hasRole('ROLE_ADMIN')")
                .antMatchers("/api/admin/**").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/api/client/**").access("hasRole('ROLE_USER')")
