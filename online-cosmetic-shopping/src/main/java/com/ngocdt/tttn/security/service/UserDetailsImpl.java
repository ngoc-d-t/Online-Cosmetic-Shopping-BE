...
public class UserDetailsImpl implements UserDetails {
	...
	public UserDetailsImpl(int accountID, String email, String password,
	...
	public static UserDetailsImpl build(Account account) {
		...
		return new UserDetailsImpl(account.getAccountID(), account.getEmail(), account.getPassword(), authorities);
	}
